# Spring PetClinic Sample Application [![Build Status](https://api.travis-ci.org/fuzzdelay/spring-petclinic.svg?branch=master&status=passed)](https://travis-ci.org/github/fuzzdelay/spring-petclinic)
